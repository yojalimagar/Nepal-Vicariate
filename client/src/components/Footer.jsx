...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-gray-200 py-8 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-gray-300">
              P.O. Box 1234, Kathmandu, Nepal<br />
              Email: <a href="mailto:info@vicariatenepal.org" className="hover:text-primary transition-colors duration-200">info@vicariatenepal.org</a><br />
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base">
              ...
              <li>
                <a href="/ministries" className="hover:text-primary transition-colors duration-200">Ministries</a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              ...
              >
                <svg
                  className="w-6 h-6 text-gray-300 hover:text-primary"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-sm text-gray-400">
          &copy; {new Date().getFullYear()} Catholic Apostolic Vicariate of Nepal. All rights reserved.
        </div>
      </div>
    </footer>
  );
